...
public class RefuseListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		DatabaseProviderRemoteService databaseProviderRemoteService = iocContainerReference
				.getBean(DatabaseProviderRemoteService.class);
		...
		System.err.println("这是RefuseListener---您的请求已被拒绝");
	}
